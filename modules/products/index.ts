...
@Module({
 ...
 providers:[ProductsService,ProductsPermissionRegistrar,{provide:PRODUCTS_REPOSITORY,useClass:PrismaProductsRepository},{provide:PRODUCT_READER,useExisting:ProductsService}],
